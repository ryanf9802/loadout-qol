...
public final class LoadoutLayoutStore {
	...
	static JsonObject migrateLegacyJson(JsonObject root) throws LoadoutLayoutException {
		if (root == null || root.get("version") == null || root.get("version").getAsInt() != LEGACY_DATA_VERSION) {
		...
		migrated.add("armor", emptyArmorJson());
		return migrated;
	}
	...
	private LoadoutLayout decodeLayout(JsonObject root, RegistryOps<JsonElement> ops) throws LoadoutLayoutException {
		...
		if (currentRoot != null && currentRoot.get("version") != null && currentRoot.get("version").getAsInt() == LEGACY_DATA_VERSION) {
